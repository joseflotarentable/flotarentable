    ...
    <div className="app">
      ...
      <div className="hdr">
        ...
        <div style={{display:"flex",alignItems:"center",gap:"0.5rem"}}>
          {esGerente&&!suscrito&&<button className="btn bp bsm" style={{padding:"0.3rem 0.6rem",width:"auto",fontSize:"0.72rem"}} onClick={()=>setShowPaywall(true)}>Activar plan</button>}
