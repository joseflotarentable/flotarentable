...
@media (min-width:900px){
  ...
  .page>.ptitle,.page>.alert,.page>.empty,.page>.g3,.page>.sgrid,.page>.phead,.page>.trip-list,.page>.gastos-var,.page>.gastos-fijos,.page>.tab-row,.page>.section-lbl{grid-column:1/-1}
