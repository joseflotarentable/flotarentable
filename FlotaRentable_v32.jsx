            ...
            <div className="trip" key={g.id} onClick={()=>openEdit(g)}>
              <div className="ttop">
                ...
                <div style={{display:"flex",alignItems:"center",gap:"0.5rem"}}>
                  ...
                  <button className="btn bd bsm" style={{padding:"0.3rem 0.4rem"}} onClick={e=>{e.stopPropagation();if(window.confirm("¿Eliminar este gasto?"))deleteGasto(g.id);}}><Icon d={I.trash} size={12}/></button>
                </div>
              </div>
        ...
        <div className="modal" onClick={e=>e.stopPropagation()}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <div style={{display:"flex",gap:"0.5rem"}}>
              {editGasto&&<button className="btn bd bsm" onClick={()=>{if(window.confirm("¿Eliminar este gasto?"))deleteGasto(editGasto.id);setModal(false);}}><Icon d={I.trash} size={14}/></button>}
...
// ── VIAJES PAGE ───────────────────────────────────────────────────────────────
function ViajesPage({userId,tractoras,semis,esGerente,gastosTodos,viajesTodos,setViajesTodos}) {
          ...
          return(
            <div className="trip" key={v.id} onClick={()=>openEdit(v)}>
              <div className="ttop">
                ...
                <button className="btn bd bsm" style={{padding:"0.3rem 0.4rem"}} onClick={e=>{e.stopPropagation();if(window.confirm("¿Eliminar este viaje?"))deleteViaje(v.id);}}><Icon d={I.trash} size={12}/></button>
              </div>
              <div className="trow">
    ...
    {modal&&<div className="ov" onClick={()=>setModal(false)}>
        <div className="modal" onClick={e=>e.stopPropagation()}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <div style={{display:"flex",gap:"0.5rem"}}>
              {editando&&<button className="btn bd bsm" onClick={()=>{if(window.confirm("¿Eliminar este viaje?"))deleteViaje(editando.id);setModal(false);}}><Icon d={I.trash} size={14}/></button>}
              <button className="btn bg bsm" onClick={()=>setModal(false)}>✕</button>
            </div>
          </div>
          <div className="g2">
...
// ── REGISTRAR PAGE ────────────────────────────────────────────────────────────
function RegistrarPage({userId,tractoras,semis,esGerente,gastosTodos,setGastosTodos,viajesTodos,setViajesTodos,accentIdx,gastosFijos,setGastosFijos}) {
