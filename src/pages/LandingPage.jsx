...
Email de contacto: contacto@flotarentable.com
...
Responsable del tratamiento: FlotaRentable (contacto@flotarentable.com)
...
Derechos: puedes ejercer tus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad escribiendo a contacto@flotarentable.com.`},
...
Para cualquier duda: contacto@flotarentable.com`},
};
...
export function LandingPage({accent,onLogin,onRegister,onBlog,onOpenPost}) {
  ...
  const reviews=[
    {n:"Antonio Ramírez",r:"Autónomo",t:"Llevaba años apuntando los gastos en una libreta y nunca sabía si un viaje merecía la pena. Con FlotaRentable veo el beneficio neto al momento, descontando hasta los gastos fijos.",init:"AR",col:"#FF3D5A"},
    ...
    {n:"Carmen Iglesias",r:"Gerente de flota",t:"Antes cada chófer apuntaba los gastos a su manera y al final de mes era un caos cuadrar todo. Ahora cada uno los registra desde el móvil con el mismo formato y yo solo tengo que revisarlos.",init:"CI",col:"#FF3D5A"},
  ];
    ...
    <div className="lp">
      ...
      <nav className="lp-nav">
        <div className="lp-logo">
          <img src="/icon-512.png" alt="" width="36" height="36" style={{borderRadius:10}}/>
          FlotaRentable
        </div>
      ...
      <section className="lp-section" id="contacto">
        ...
        <div className="lp-pricing">
          <div style={{fontSize:"0.95rem",fontWeight:700,marginBottom:"0.5rem"}}>📧 contacto@flotarentable.com</div>
