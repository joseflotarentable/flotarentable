...
function GastosPage({userId,tractoras,semis,esGerente,accentIdx}) {
  ...
  const emptyForm={fecha:new Date().toISOString().slice(0,10),tipo:"Combustible",titulo:"",importe:"",litros:"",precio_litro:"",odometro:"",pais:"España",vehicle_id:tractoras[0]?.id||"",vehicle_tipo:"tractora",nota:"",mes:mesFiltro,ano:anoActual};
