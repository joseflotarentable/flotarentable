...
// ── REGISTRAR PAGE ────────────────────────────────────────────────────────────
function RegistrarPage({userId,tractoras,semis,esGerente,gastosTodos,accentIdx}) {
  ...
  return(
    <div className="page fu">
      ...
      {subtab==="viajes"&&<ViajesPage userId={userId} tractoras={tractoras} semis={semis} esGerente={esGerente} gastosTodos={gastosTodos} embedded={true}/>}
      {subtab==="gastos"&&<GastosPage userId={userId} tractoras={tractoras} semis={semis} esGerente={esGerente} accentIdx={accentIdx} embedded={true}/>}
    </div>
  );
}
...
export default function App() {
  ...
  const tabs=[{id:"inicio",lbl:"Inicio",icon:I.dash},{id:"flota",lbl:"Flota",icon:I.truck},{id:"registrar",lbl:"Registrar",icon:I.plus},{id:"analizar",lbl:"Analizar",icon:I.analyze}];
  ...
  return(
    ...
    <div className="app">
      ...
      {tab==="registrar"&&<RegistrarPage userId={user.id} tractoras={tractoras} semis={semis} esGerente={esGerente} gastosTodos={gastosTodos} accentIdx={perfil.accent_idx||0}/>}
